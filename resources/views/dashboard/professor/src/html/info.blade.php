...
@endif
      ...
      <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input value="{{ $professor->first_name}}" name="first_name" type="text" class="form-control" id="nomEtudiant">
        </div>
        <div class="mb-3">
          <label for="filiere" class="form-label">Filière</label>
          <input  value="{{ $professor->sector}}" type="text" class="form-control" id="filiere">
        </div>
        <div class="mb-3">
          <label for="profEmail" class="form-label">Email du professeur</label>
          <input value="{{ $professor->email}}" type="email" class="form-control" id="profEmail">
        </div>
        <div class="mb-3">
          <label for="profPassword" class="form-label">Mot de passe</label>
          <div class="input-group">
            <input value="changer votre mot de passe" type="password" class="form-control" id="profPassword">
